...
CameraDisplay::CameraDisplay(int input_image_height, int input_image_width, string display_name) :
port_height_(input_image_height * 2),	//ASK why twice larger?
port_width_(input_image_width * 2),
