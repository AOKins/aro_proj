...
#include "stdafx.h"
#include "BlinkPCIeSDK.h"

// Handles F1 Help Menu
BEGIN_MESSAGE_MAP(CBlinkPCIeSDKApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()

// Singleton design app reference
CBlinkPCIeSDKApp theApp;

// [CONSTRUCTOR(S)]
CBlinkPCIeSDKApp::CBlinkPCIeSDKApp() {}


// [INITIALIZER]
BOOL CBlinkPCIeSDKApp::InitInstance()
{
